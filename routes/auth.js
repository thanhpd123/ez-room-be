...
const { register, registerOAuth, login, forgotPassword, resetPassword, updateProfile, getLifestyle, upsertLifestyle, getPreference, upsertPreference, suggestPassword, verifyEmail, verifyLogin, resendCode } = require('../controllers/auth.controller');
 ...
 * Body: { email, code }
 * Xác thực OTP sau đăng ký → kích hoạt tài khoản
 */
 ...
 * Body: { email, code }
 * Xác thực OTP sau đăng nhập → trả JWT token
 */
